...
const PerformanceMonitor: React.FC = memo(() => {
  ...
  const collectMetrics = () => {
    ...
    if (navigation) {
      ...
      const loadComplete = Math.round(navigation.loadEventEnd - navigation.navigationStart);
      ...
      setResourceUsage({
        ...
        timing: {
          ...
          firstContentfulPaint: Math.round(navigation.responseEnd - navigation.navigationStart)
        }
      });
    }
